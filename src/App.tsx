        ...
        <div className="container">
          ...
          <div className="budget-overview">
            <p className="budget-info">
              <span className="budget-label">Fees:</span> $1,295 attendee · $150 pre-workshop |
              <span className="budget-label">Head-count:</span> 60 paid + 10 comp |
              <span className="budget-label">Income:</span> ≈ $64,750 |
              <span className="budget-label">F&B target:</span> 60–65% |
              <span className="budget-label">AV & Misc:</span> 15–20% |
              <span className="budget-label">Room block:</span> 45 rooms × 3 nights @ $250 |
              <span className="budget-label">Space rental:</span> typically comped via F&B
            </p>
          </div>
